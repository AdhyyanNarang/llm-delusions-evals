...
#
# Usage:
#   bash scripts/run_context_eval.sh <model> <max_context_messages> [codes] [log_dir] [min_context_messages]
#
# Examples:
...
MODEL="${1:?Usage: bash scripts/run_context_eval.sh <model> <max_context_messages> [codes] [log_dir] [min_context_messages]}"
MAX_CONTEXT_MESSAGES="${2:?Usage: bash scripts/run_context_eval.sh <model> <max_context_messages> [codes] [log_dir] [min_context_messages]}"
CODES="${3:-}"
...
elif [ "$MAX_CONTEXT_MESSAGES" -gt 0 ]; then
