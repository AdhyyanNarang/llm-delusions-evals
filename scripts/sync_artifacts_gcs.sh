...
#
# Examples:
#   bash scripts/sync_artifacts_gcs.sh upload llm-delusions-evals-artifacts
#   bash scripts/sync_artifacts_gcs.sh download llm-delusions-evals-artifacts
#   bash scripts/sync_artifacts_gcs.sh upload llm-delusions evals/release-2026-05-04
#
# Synced directories:
#   logs/
#   logs-context/
