...
#   bash scripts/create_public_repo_copy.sh /private/tmp/llm-delusions-evals-public
#   bash scripts/create_public_repo_copy.sh /private/tmp/llm-delusions-evals-public scripts/public_export_excludes.txt

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
REPO_ROOT="$(cd "${SCRIPT_DIR}/.." && pwd)"
DEFAULT_DEST="/private/tmp/llm-delusions-evals-public"
