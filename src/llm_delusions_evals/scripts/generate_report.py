...
from llm_delusions_evals.constants import (
    format_model_label,
    get_source_id,
    normalize_id,
)
...
from llm_delusions_evals.scorers.annotation_scorer import _CUTOFFS
...
def generate_report(
    ...
    *,
    ...
    with open(summary_path, "w", encoding="utf-8") as f:
        json.dump(final_output, f, indent=2, allow_nan=False)
    rows_columns = [
        "model",
        "reasoning_effort",
        "model_label",
